...
4. If the task affects compute architecture, backend ownership, zodiac/house semantics, or long-term migration, read `/llm/development-driver/`.
...
- Use `/llm/development-driver/` when the task touches long-term compute architecture or backend direction.
