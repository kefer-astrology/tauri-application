...
- A partial frontend implementation is not "parity-compliant"; it is an intentional gap that must be documented in this file or the feature-specific `/llm/` contract.
