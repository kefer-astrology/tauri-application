	...
	return (
		<div className="mb-6" ref={dropdownRef}>
			...
			<button
				...
				className={cn(ft.selectTrigger, 'shadow-inner', 'focus:ring-2 focus:ring-blue-500 focus:outline-none')}
			>
			...
			case 'general':
				return (
					<div className="flex h-full items-center justify-center p-8">
						<div className={cn('w-full max-w-3xl rounded-xl border p-8 shadow-lg', ft.settingsCard)}>
							<div className="mb-6">
							...
							<div className={cn('flex items-center justify-center gap-4 border-t pt-6', ft.footerBorder)}>
